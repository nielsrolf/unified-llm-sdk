...
try:
    ...
    anthr_models = ["claude-2.1", "claude-3-opus-20240229"]
except:  # noqa
    anthr = None
    anthr_models = []
...
def list_of_dicts_to_xml_str(
    list_of_dicts, root_tag="tools", child_tag="tool_definition", indent=True
):
    """
...
def get_response_anthropic_with_tools(
    ...
    **kwargs,
    ...
    action = {"name": parsed_response["name"], "args": parsed_response["parameters"]}
